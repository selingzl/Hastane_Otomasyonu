 ...
 * @author Lenovo
 */
public class hesapbilgilerim extends javax.swing.JFrame {

    /**
     * Creates new form hesapbilgilerim
     */
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tc, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
                            .addComponent(sifre))
                        .addGap(134, 134, 134)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(hashmap.signpanelhasta.containsKey(t)){
        hashmap.signpanelhastaad.replace(t, hashmap.hAD, a);
        hashmap.signpanelhasta.replace(t, hashmap.hsifre, s);}
        else{
            hashmap.signpanelhasta.remove(hashmap.hastaTC,hashmap.hsifre );
            hashmap.signpanelhastaad.remove(hashmap.hastaTC,hashmap.hAD );
            hashmap.signpanelhastaad.put(t, a);
            hashmap.signpanelhasta.put(t,s);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hesapbilgilerim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hesapbilgilerim().setVisible(true);
            }
        });
    }
